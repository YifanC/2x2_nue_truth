...
def is_cc(event):
    ...
    particle_id = get_traj_ids_for_pdg(event.Primaries[0].Particles, [11, -11, 13, -13])
    ...
    ## CC
        ...
        print("ccnc: particle_id ", particle_id)
        return True

def is_nue_ccinc(pdg_list):
    if 11 in pdg_list or -11 in pdg_list:
        return True
    return False
...
output_file = 'nue_evt_info_new.h5'
